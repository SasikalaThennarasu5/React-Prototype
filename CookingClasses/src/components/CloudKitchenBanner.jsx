  ...
  return (
    <div>
            ...
            <div className="relative w-full max-w-7xl">
                ...
                <p className="absolute w-[80%] sm:w-3/4 top-8 left-1/2 transform -translate-x-1/2 z-10 text-white font-medium text-xl md:text-base lg:text-2xl">
                    Launch and grow your business in the next 60 days with the bakery acceleration program
                </p>
                ...
                <div className="absolute left-5 md:left-36 top-32 md:top-48 lg:top-52 text-white text-left space-y-4 text-sm md:text-base lg:text-xl z-10 leading-relaxed mt-2 md:mt-4 lg:mt-10">
                    <p className="flex items-center gap-3">
                        <img src={calender} alt="Batch Icon" className="w-6 h-6" />
                    ...
                    <p className="flex items-center gap-3">
                        <img src={recipe} alt="Spoon Icon" className="w-6 h-6" />
                        100+ Baking Recipes
                    </p>
                    <p className="flex items-center gap-3">
...
/>
                ...
                <div className="absolute bottom-24 md:bottom-1 lg:bottom-2 left-1/2 transform -translate-x-1/2 translate-y-1/2 z-20 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-12 lg:gap-48">
                  <img src={followers} alt="Instagram Icon" className="w-22 md:w-28 lg:w-40" />
                  <img src={books} alt="Author Icon" className="w-22 md:w-28 lg:w-40" />
                  <img src={experience} alt="Expertise Icon" className="w-22 md:w-28 lg:w-40" />
                </div>
