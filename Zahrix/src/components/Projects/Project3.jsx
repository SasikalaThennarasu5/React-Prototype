  ...
  return (
    <>
      ...
      <h2 className="text-3xl font-bold text-black text-center">
        Fire Alarm Installation at GHI Tower
      </h2>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-start gap-6 px-4 lg:px-16 py-10 mx-4 md:mx-10">
        ...
        <div className="rounded-2xl overflow-hidden shadow-lg w-full lg:w-1/3">
          <img src={img1} alt="Fire Alarm Panel" className="w-full h-full object-cover" />
        </div>
        ...
        {/* Right Image Card */}
        <div className="rounded-2xl overflow-hidden shadow-lg w-full lg:w-1/3">
          <img src={img3} alt="Smoke Detector" className="w-full h-full object-cover" />
        </div>
      </div>
