...
import bmshero from '../assets/images/Screenshot 2025-06-12 114508.png'; 
...
import person from '../assets/images/Screenshot 2025-06-12 170435.png';
const BMS = () => {
  return (
    <>
    <section
      className="relative h-[50vh] sm:h-[60vh] bg-cover bg-center"
      style={{ backgroundImage: `url(${bmshero})` }}
    >
