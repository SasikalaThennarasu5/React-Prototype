...
const Billing = () => {
  ...
  return (
    <div
      className="billing-wrapper d-flex justify-content-center align-items-start py-5"
      style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}
    >
      <div className="container bg-white p-4 shadow rounded" style={{ maxWidth: '900px' }}>
